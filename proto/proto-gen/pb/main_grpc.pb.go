...
const (
	...
	HelloService_SayHello2_FullMethodName = "/main.HelloService/SayHello2"
)
...
func (c *helloServiceClient) SayHello2(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, HelloService_SayHello2_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServiceServer) SayHello2(context.Context, *HelloRequest) (*HelloResponse, error) {
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/protofiles/main.proto",
}
